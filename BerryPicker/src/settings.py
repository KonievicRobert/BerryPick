"""
This file contains settings for the BerryPicker project. These can be considered as constants for a particular run, 
but they might have different values on different computers or setups.
